package com.software2.bookService.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.software2.bookService.*.*(..))")
    ...
    @Pointcut("execution(* com.software2.bookService.Repository..*(..))")
    public void forRepositoryLog() {}

    @Pointcut("execution(* com.software2.bookService.Service..*(..))")
    public void forServiceLog() {}

    @Pointcut("execution(* com.software2.bookService.Controller..*(..))")
