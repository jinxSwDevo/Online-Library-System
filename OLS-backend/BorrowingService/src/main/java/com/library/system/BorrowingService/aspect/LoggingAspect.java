package com.library.system.BorrowingService.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.library.system.BorrowingService.*.*(..))")
    ...
    @Pointcut("execution(* com.library.system.BorrowingService.Repository..*(..))")
    public void forRepositoryLog() {}

    @Pointcut("execution(* com.library.system.BorrowingService.Service..*(..))")
    public void forServiceLog() {}

    @Pointcut("execution(* com.library.system.BorrowingService.Controller..*(..))")
