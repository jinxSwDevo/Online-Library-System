package com.library.system.ReportService.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.library.system.ReportService.*.*(..))")
    ...
    @Pointcut("execution(* com.library.system.ReportService.Repository..*(..))")
    public void forRepositoryLog() {}

    @Pointcut("execution(* com.library.system.ReportService.Service..*(..))")
    public void forServiceLog() {}

    @Pointcut("execution(* com.library.system.ReportService.Controller..*(..))")
